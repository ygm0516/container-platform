...
1. [문서 개요](#1)
    * [1.1. 목적](#1-1)
    * [1.2. 범위](#1-2)
2. [플레이파크 컨테이너 플랫폼 포털 접속](#2)
    * [2.1. 플레이파크 컨테이너 플랫폼 포털 접속](#2-1)
3. [플레이파크 컨테이너 플랫폼 포털을 사용한 MySQL과 WordPress 배포](#3)
    * [3.1.플레이파크 컨테이너 플랫폼 포털 사용한 MySQL 배포](#3-1)
    ...
    * [3.3. 서비스 접속 확인](#3-3)
4. [(참고)플레이파크 컨테이너 플랫폼 포털을 사용한 WordPress와 MySQL 삭제](#4)
    * [4.1.플레이파크 컨테이너 플랫폼 포털을 사용한 WordPress 삭제](#4-1)
    ...
    * [4.2.플레이파크 컨테이너 플랫폼 포털을 사용한 MySQL 삭제](#4-2)
...
## <div id='1-2'/> 1.2. 범위
플레이파크를를 사용하여 MySQL 데이터베이스와 WordPress 사이트를 배포하는 방법에 대해 작성되었다.
...
# <div id='4'/> 4. (참고) 플레이파크 컨테이너 플랫폼 포털을 사용한 WordPress와 MySQL 삭제 
본 장에서는 컨테이너 플랫폼 포털을 사용하여 WordPress와 MySQL을 삭제하는 방법에 대해서 기술한다.


## <div id='4-1'/> 4.1. 플레이파크 컨테이너 플랫폼 포털을 사용한 WordPress 삭제
...
## <div id='4-2'/> 4.2. 플레이파크 컨테이너 플랫폼 포털을 사용한 MySQL 삭제
   * 일반적으로 삭제는 배포 순서의 반대로 진행한다.
